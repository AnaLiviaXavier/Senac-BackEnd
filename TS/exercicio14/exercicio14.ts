...
o sistema de organização de estoque da empresa. A pessoa desenvolvedora anterior a você chegou a 
...
Aproveitando a função já feita, faça uma nova função que receba o `array`de estoque como 
parâmetro, use a função `ajustaPreco` para corrigir os preços e retorne a lista de estoque 
